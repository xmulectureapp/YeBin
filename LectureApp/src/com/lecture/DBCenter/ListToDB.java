...
public class ListToDB extends SQLiteOpenHelper {
	...
	// --------------------LECTURE_TABLE, Total:13 ROWS---------------------------//
		...
		public List<Map<String, Object>> L_converCursorToList(Cursor cursor) {
			...
			while (cursor.moveToNext()) {
				...
				map.put("what", cursor.getString(3));
				map.put("when", cursor.getString(4));
				map.put("where", cursor.getString(9));
				map.put("who", cursor.getString(6));
	...
	public ListToDB(Context context, String name, CursorFactory factory,
			int version) {
	...
	public ListToDB(Context context, String name, int version) {
